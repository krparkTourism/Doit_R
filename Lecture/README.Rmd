...
- [Lecture.zip](https://github.com/krparkTourism/Doit_R/blob/master/Lecture/Lecture.zip) 을 다운받으면 전체 파일을 한 번에 받으실 수 있습니다. 
...
### 1. 워드 스타일 적용 
1. [RMD](https://github.com/krparkTourism/Doit_R/tree/master/Lecture/RMD) 폴더의 `WordTemplate.dotx`를 워드 템플릿 폴더에 삽입 
